...
class Helpers {
	// $names = Helpers::generateModuleNames($module_name);
	...
	// Helpers::parseValues($field['popup_vals']);
	...
	// Helpers::log("info", "", $commandObject);
	...
	// Helpers::createThumbnail($filepath, $thumbpath, $thumbnail_width, $thumbnail_height);
	...
	// Helpers::print_menu_editor($menu)
	...
	// Helpers::print_menu_topnav($menu)
	...
	// Helpers::setenv("CACHE_DRIVER", "array");
