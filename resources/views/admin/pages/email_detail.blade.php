						...
						<div data-scrollbar="true" data-height="100%">
							...
							<div class="wrapper p-0">
								...
								<ul class="nav nav-inbox">
									<li class="active"><a href="{{ url('inbox') }}" data-toggle="ajax"><i class="fa fa-inbox fa-fw m-r-5"></i> Inbox <span class="badge pull-right">52</span></a></li>
									<li><a href="{{ url('inbox') }}" data-toggle="ajax"><i class="fa fa-flag fa-fw m-r-5"></i> Important</a></li>
									<li><a href="{{ url('inbox') }}" data-toggle="ajax"><i class="fa fa-envelope fa-fw m-r-5"></i> Sent</a></li>
									<li><a href="{{ url('inbox') }}" data-toggle="ajax"><i class="fa fa-pencil-alt fa-fw m-r-5"></i> Drafts</a></li>
									<li><a href="{{ url('inbox') }}" data-toggle="ajax"><i class="fa fa-trash fa-fw m-r-5"></i> Trash</a></li>
								</ul>
		...
		<div class="vertical-box">
			...
			<div class="wrapper bg-silver-lighter clearfix">
				...
				<div class="pull-right">
					<div class="btn-group">
						<a href="{{ url('inbox') }}" data-toggle="ajax" class="btn btn-white btn-sm disabled"><i class="fa fa-arrow-up f-s-14 t-plus-1"></i></a>
						<a href="{{ url('inbox') }}" data-toggle="ajax" class="btn btn-white btn-sm"><i class="fa fa-arrow-down f-s-14 t-plus-1"></i></a>
					</div>
					<div class="btn-group m-l-5">
						<a href="{{ url('inbox') }}" data-toggle="ajax" class="btn btn-white btn-sm"><i class="fa fa-times f-s-14 t-plus-1"></i></a>
					</div>
				</div>
			</div>
			<!-- end wrapper -->
							...
							<div class="wrapper">
								...
								<ul class="media-list underline m-b-15 p-b-15">
									<li class="media media-sm clearfix">
										<a href="javascript:;" class="pull-left">
											<img class="media-object rounded-corner" alt="" src="{{ asset('public/img/user/user-12.jpg') }}" />
										</a>
										<div class="media-body">
											<div class="email-from text-inverse f-s-14 f-w-600 m-b-3">
												from bayutrisnapati@gmail.com
											</div>
											<div class="m-b-3"><i class="fa fa-clock fa-fw"></i> Today, 8:30 AM</div>
											<div class="email-to">
												To: admin@fiftytwo.co.id
											</div>
										</div>
									</li>
								</ul>
								<ul class="attached-document clearfix">
									...
									<li class="fa-camera">
										<div class="document-file">
											<a href="javascript:;">
												<img src="{{ asset('public/img/gallery/gallery-11.jpg') }}" alt="" />
											</a>
										</div>
			...
			<div class="wrapper bg-silver-lighter text-right clearfix">
				<div class="btn-group">
					<a href="{{ url('inbox') }}" data-toggle="ajax" class="btn btn-white btn-sm disabled"><i class="fa fa-arrow-up"></i></a>
					<a href="{{ url('inbox') }}" data-toggle="ajax" class="btn btn-white btn-sm"><i class="fa fa-arrow-down"></i></a>
				</div>
				<div class="btn-group m-l-5">
					<a href="{{ url('inbox') }}" data-toggle="ajax" class="btn btn-white btn-sm"><i class="fa fa-times"></i></a>
				</div>
			</div>
			<!-- end wrapper -->
		</div>
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script>
    App.setPageTitle('52 Admin | Email Detail');
	App.setPageOption({
