<link rel="stylesheet" type="text/css" href="{{ asset('public/plugins/jquery-filetree/jQueryFileTree.min.css') }}"/>
<link rel="stylesheet" type="text/css" href="{{ asset('public/css/52style.css') }}"/>
...
<script src="{{ asset('public/plugins/jquery-filetree/jQueryFileTree.min.js') }}"></script>
<script src="{{ asset('public/plugins/ace/ace.js') }}" type="text/javascript" charset="utf-8"></script>
<script src="{{ asset('public/plugins/ace/ext-modelist.js') }}" type="text/javascript" charset="utf-8"></script>
