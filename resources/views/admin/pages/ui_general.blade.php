			...
			<div class="panel-body">
				<div>
					<ul class="pagination pagination-lg m-t-0 m-b-5">
						...
						<li class="page-item"><a href="javascript:;" class="page-link">Â»</a></li>
					</ul>
				</div>
				<div>
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script>
    App.setPageTitle('52 Admin | General UI Elements');
    App.restartGlobalFunction();
    
    $.when(
		$.getScript('{{ asset("plugins/highlight/highlight.common.js") }}'),
