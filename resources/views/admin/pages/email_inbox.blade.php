						...
						<div data-scrollbar="true" data-height="100%">
							...
							<ul class="list-group list-group-lg no-radius list-email">
								<li class="list-group-item unread">
									...
									<a href="{{ route('detail') }}" data-toggle="ajax" class="email-user bg-gradient-blue">
										<span class="text-white">F</span>
									</a>
									<div class="email-info">
										<a href="{{ route('detail') }}" data-toggle="ajax">
								...
								<li class="list-group-item unread">
									...
									<a href="{{ url('detail') }}" data-toggle="ajax" class="email-user bg-gradient-purple">
										<span class="text-white">C</span>
									</a>
									<div class="email-info">
										<a href="{{ url('detail') }}" data-toggle="ajax">
											<span class="email-time">Today</span>
								...
								<li class="list-group-item unread">
									...
									<a href="{{ url('detail') }}" data-toggle="ajax" class="email-user bg-grey">
								...
								<li class="list-group-item">
									...
									<a href="{{ url('detail') }}" data-toggle="ajax" class="email-user">
										<img src="{{ asset('public/img/user/user-12.jpg') }}" alt="" />
									</a>
									<div class="email-info">
										<a href="{{ route('detail') }}" data-toggle="ajax">
								...
								<li class="list-group-item">
									...
									<a href="{{ url('detail') }}" data-toggle="ajax" class="email-user">
										<img src="{{ asset('public/img/user/user-1.jpg') }}" alt="" />
									</a>
									<div class="email-info">
										<a href="{{ url('detail') }}" data-toggle="ajax">
											<span class="email-time">2 months ago</span>
								...
								<li class="list-group-item">
									...
									<a href="{{ url('detail') }}" data-toggle="ajax" class="email-user">
										<img src="{{ asset('public/img/user/user-14.jpg') }}" alt="" />
									</a>
									<div class="email-info">
										<a href="{{ url('detail') }}" data-toggle="ajax">
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script>
    App.setPageTitle('52 Admin | Email Inbox');
	App.setPageOption({
	...
	$.when(
		$.getScript('{{ asset("public/js/demo/email-inbox.demo.min.js") }}'),
