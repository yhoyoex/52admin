    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="header" class="header navbar-default">
            ...
            <div class="navbar-header">
                <a href="{{ route('admin') }}" class="navbar-brand"><span class="navbar-logo"></span> <b>52</b> Admin</a>
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu media-list dropdown-menu-right">
                        ...
                        <li class="media">
                            <a href="javascript:;">
                                <div class="media-left">
                                    <img src="{{ asset('public/img/user/user-1.jpg') }}" class="media-object" alt="" />
                        ...
                        <li class="media">
                            <a href="javascript:;">
                                <div class="media-left">
                                    <img src="{{ asset('public/img/user/user-2.jpg') }}" class="media-object" alt="" />
                                    <i class="fab fa-facebook-messenger text-primary media-object-icon"></i>
                                </div>
                                <div class="media-body">
                ...
                <li class="dropdown navbar-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('public/img/user/user-13.jpg') }}" alt="" /> 
            ...
            <div data-scrollbar="true" data-height="100%">
                ...
                <ul class="nav" id='nav_profile'>
                    ...
                    <li>
                        <ul class="nav nav-profile">
                            ...
                            <li><a href="{{ url('editor') }}" data-toggle="ajax"><i class="fa fa-code"></i> File Editor</a></li>
                            <li><a href="{{ url('modules') }}" data-toggle="ajax"><i class="fa fa-cubes"></i> Modules</a></li>
                        </ul>
                    </li>
                </ul>
                <!-- end sidebar user -->
                ...
                <ul class="nav">
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ route('dashboard') }}" data-toggle="ajax">Dashboard v1</a></li>
                            <li><a href="{{ route('dashboard2') }}" data-toggle="ajax">Dashboard v2</a></li>
                        </ul>
                    </li>
                    <li class="has-sub">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ url('inbox') }}" data-toggle="ajax">Inbox</a></li>
                            <li><a href="{{ url('compose') }}" data-toggle="ajax">Compose</a></li>
                            <li><a href="{{ url('detail') }}" data-toggle="ajax">Detail</a></li>
                        </ul>
                    </li>
                    <li class="has-sub">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu">
                            <li><a href="#pages/ui_general.html" data-toggle="ajax">General</a></li>
                            ...
                            <li><a href="#pages/ui_modal_notification.html" data-toggle="ajax">Modal & Notification <i class="fa fa-paper-plane text-theme m-l-5" data-toggle="ajax"></i></a></li>
                            ...
                            <li><a href="#pages/ui_buttons.html" data-toggle="ajax">Buttons</a></li>
                    ...
                    <li>
                        <a href="#pages/bootstrap_4.html" data-toggle="ajax">
                            <div class="icon-img">
                                <img src="{{ asset('public/img/logo/logo-bs4.png') }}" alt="" />
                            </div>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="#pages/table_manage.html" data-toggle="ajax">Default</a></li>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            <li><a href="/frontend/blog/" target="_blank">One Page Parallax</a></li>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="https://seantheme.com/color-admin-v4.0/admin/angularjs/index.html">ANGULAR JS</a></li>
                            <li><a href="https://seantheme.com/color-admin-v4.0/admin/angularjs5/index.html">ANGULAR JS 5 <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
                            ...
                            <li><a href="https://seantheme.com/color-admin-v4.0/admin/material/index.html">MATERIAL DESIGN</a></li>
                            <li><a href="https://seantheme.com/color-admin-v4.0/admin/template_apple/index.html">APPLE DESIGN</a></li>
                            <li><a href="https://seantheme.com/color-admin-v4.0/admin/transparent/index.html">TRANSPARENT DESIGN <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
                        </ul>
                    </li>
                    <li class="has-sub">
                        <a href="javascript:;">
        ...
        <div class="theme-panel">
            ...
            <div class="theme-panel-content">
                ...
                <ul class="theme-list clearfix">
                    ...
                    <li><a href="javascript:;" class="bg-blue" data-theme="blue" data-theme-file="{{ asset('public/css/admin/theme/blue.css') }}" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Blue">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-purple" data-theme="purple" data-theme-file="{{ asset('public/css/admin/theme/purple.css') }}" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Purple">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-orange" data-theme="orange" data-theme-file="{{ asset('public/css/admin/theme/orange.css') }}" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Orange">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-black" data-theme="black" data-theme-file="{{ asset('public/css/admin/theme/black.css') }}" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Black">&nbsp;</a></li>
                </ul>
...
<!-- <script>
  ...
  })(window,document,'script','{{ asset('public/js/analytics.js') }},'ga');
